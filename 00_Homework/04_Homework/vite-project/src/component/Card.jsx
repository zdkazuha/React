        ...
        <li>
            <div className="Card">
                <div className="Top">
                    ...
                    <p className={discount === undefined || discount === 0 ? "notDiscount" : "Discount"}>-{discount}%</p>
                </div>
                ...
                <div className="Bottom">
                    ...
                    <p className={discount === undefined || discount === 0  ? "Price" : "OldPrice"} >{price} $</p>
                    <p className={discount === undefined || discount === 0  ? "notDiscount" : "NewPrice"}>{price - (price * discount / 100)} $</p>
                </div>
